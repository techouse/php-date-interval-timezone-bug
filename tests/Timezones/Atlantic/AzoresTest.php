 ...
 * Class AzoresTest
 *
 * DST Starts on Sunday, March 31, 2019 At 0:00:00 AM local standard time
 * DST Ends on Sunday, October 27, 2019 At 1:00:00 AM local daylight time
 *
 * @package Unit\Atlantic
 */
class AzoresTest extends TestCase
{
    protected function setUp(): void
    {
        ...
        self::setTimezone('Atlantic/Azores');
    }
