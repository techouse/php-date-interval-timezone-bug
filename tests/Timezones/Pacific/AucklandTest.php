 ...
 * DST Starts on Sunday, September 29, 2019 At 2:00:00 AM local standard time
 *
 * @package Unit\Pacific
 */
class AucklandTest extends TestCase
{
    protected function setUp(): void
    {
        ...
        self::setTimezone('Pacific/Auckland');
    }
