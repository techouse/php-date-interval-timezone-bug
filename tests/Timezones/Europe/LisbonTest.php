 ...
 * Class LisbonTest
 *
 * DST Starts on Sunday, March 31, 2019 At 1:00:00 AM local standard time
 * DST Ends on Sunday, October 27, 2019 At 2:00:00 AM local daylight time
 *
 * @package Unit\Europe
 */
class LisbonTest extends TestCase
{
    protected function setUp(): void
    {
        ...
        self::setTimezone('Europe/Lisbon');
    }
