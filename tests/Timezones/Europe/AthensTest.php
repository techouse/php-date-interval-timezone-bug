 ...
 * Class AthensTest
 *
 * DST Starts on Sunday, March 31, 2019 At 3:00:00 AM local standard time
 * DST Ends on Sunday, October 27, 2019 At 4:00:00 AM local daylight time
 *
 * @package Unit\Europe
 */
class AthensTest extends TestCase
{
    protected function setUp(): void
    {
        ...
        self::setTimezone('Europe/Athens');
    }
